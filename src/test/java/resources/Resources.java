...
public class Resources {
    ...
    private static void initPerturbationLocation0() {
        __L0 = new PerturbationLocationImpl("resources.Resources.java:4", 0, "Numerical");
        __L1 = new PerturbationLocationImpl("resources.Resources.java:5", 1, "Numerical");
        __L2 = new PerturbationLocationImpl("resources.Resources.java:5", 2, "Numerical");
        __L3 = new PerturbationLocationImpl("resources.Resources.java:5", 3, "Numerical");
        __L4 = new PerturbationLocationImpl("resources.Resources.java:5", 4, "Boolean");
        __L5 = new PerturbationLocationImpl("resources.Resources.java:6", 5, "Numerical");
        __L6 = new PerturbationLocationImpl("resources.Resources.java:6", 6, "Numerical");
        __L7 = new PerturbationLocationImpl("resources.Resources.java:6", 7, "Numerical");
        __L8 = new PerturbationLocationImpl("resources.Resources.java:7", 8, "Numerical");
    }
}
